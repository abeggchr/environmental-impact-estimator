...
export class TravelCalculator {
    ...
    public calculate(team: ITeam): Impact {
        ...
        const numberOfOnewayTravelsFromMainToRemoteLocation = numberOfGroupTravelsFromMainToRemoteLocation * team.distribution_percentage.mainLocation * team.teamSize_nr * 2;
        const numberOfGroupTravelsFromRemoteToMainLocation = numberOfTravels * team.travelDistributionFrom_percentage.remoteLocation;
        const numberOfOnewayTravelsFromRemoteToMainLocation = numberOfGroupTravelsFromRemoteToMainLocation * team.distribution_percentage.remoteLocation * team.teamSize_nr * 2;
